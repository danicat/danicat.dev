...
In April, I joined the Developer Relations team at Google. It was a dream decades in the making, and the reality has lived up to the hype. It’s been intense, sure. I’ve traveled all around UK, Europe and even found some time to reconnect with the developer community back in [Brazil]({{< ref "/posts/20251029-six-months-at-google" >}}).

But more than the miles traveled, it was the intellectual journey. I dove headfirst into the Google Cloud ecosystem, getting my hands dirty with [Vertex AI]({{< ref "/posts/20250605-vertex-ai-sdk-python" >}}), [MCP]({{< ref "/posts/20250817-hello-mcp-world" >}}), and the [Agent Development Kit (ADK)]({{< ref "/posts/20251020-diagnostic-agent-with-adk" >}}). It was a crash course in the future of software, and I loved every minute of it.

## The year of vibe coding

If 2024 was about "playing" with AI, 2025 was the year I started **embracing** it. I went from a skeptic to a full-blown evangelist for ["vibe coding"]({{< ref "/posts/20251206-taming-vibe-coding" >}}). But no, not [**that**](https://x.com/karpathy/status/1886192184808149383?lang=en) vibe coding you are thinking about.
...
I also built a [modern developer workflow]({{< ref "/posts/20250714-developer-workflow" >}}) where the developer act as the "pilot," steering a fleet of AI agents like the [Gemini CLI](https://geminicli.com/) and [Jules](https://jules.google/).

This shift wasn't just philosophical; it was practical. I "vibe coded" entirely new tools to solve my own problems:
*   **[GoDoctor]({{< ref "/posts/20250729-how-to-build-an-mcp-server-with-gemini-cli-and-go" >}}):** An MCP server to teach AI how to write better Go code.
*   **[Speedgrapher]({{< ref "/posts/20250805-introducing-speedgrapher" >}}):** A toolkit to automate the boring parts of technical writing.
*   **[AIDA]({{< ref "/posts/20251031-building-aida" >}}):** My "Star Trek" computer dream come true — a diagnostic agent that actually talks back.
...
I bet big on this technology, delivering a [keynote at GopherCon UK]({{< ref "/posts/20250817-hello-mcp-world" >}}) and writing extensively about how to build your own servers. Seeing the community rally around this standard has been incredibly validating. We are no longer just chatting with bots; we are building systems that *do* things.
...
I also spent a lot of time thinking about time itself. My exploration into [why time seems to speed up as we age]({{< ref "/posts/20250811-a-model-for-perceived-time" >}}) resonated with many of you. It started as a shower thought that was powered up by AI... I know many people say that AI is bad for creativity, but I like playing with it to explore thoughts and ideas I wouldn't have the time, patience or dedication to explore in real life. For me the power of AI is enabling me to do things that I wouldn't do otherwise (unfortunately it still can't do the dishes, but I will be first in line to buy an anime robot maid).
